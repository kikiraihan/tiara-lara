@script
<script>
    Livewire.on('reloadScatterVolumePembelian', (fromServer) => {
    ...
    function getElement() {
        return {
            containerElement: document.getElementById('container-scatter_volume_pembelian_nra'),
        };
    }
    ...
    function createChart(element, data, data_regression) {
        ...
        const volume_pembelian = Object.values(data.volume_pembelian);
        ...
        const layout = {
            title: {
                text: 'Hubungan antara volume_pembelian dan NRA_PRED',
                font: {
                    size: 18,
                    color: textColor
                }
