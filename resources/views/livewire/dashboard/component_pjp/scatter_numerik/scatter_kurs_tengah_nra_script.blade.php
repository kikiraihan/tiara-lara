@script
<script>
    Livewire.on('reloadScatterKursTengah', (fromServer) => {
    ...
    function getElement() {
        return {
            containerElement: document.getElementById('container-scatter_kurs_tengah_nra'),
        };
    }
    ...
    function createChart(element, data, data_regression) {
        ...
        const kurs_tengah = Object.values(data.kurs_tengah);
        ...
        const layout = {
            title: {
                text: 'Hubungan antara kurs_tengah dan NRA_PRED',
                font: {
                    size: 18,
                    color: textColor
                }
